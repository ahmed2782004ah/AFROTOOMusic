...
from AFROTOMusic.plugins.play.Data import get_data
from googletrans import Translator
from AFROTOMusic.plugins.play.Data import (get_call, get_app, get_userbot, get_group, get_channel, must_join)
